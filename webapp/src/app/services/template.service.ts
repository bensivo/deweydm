...
export class TemplateService {
    ...
    private getProjectTrackerTemplate(): Template {
        const entities: Entity[] = [
            ...
            },
            {
                ...
                fields: [
                    ...
                    { id: '1772310750000-projectstatus', name: 'Status', type: 'option', optionValues: ['Not Started', 'In Progress', 'Completed', 'On Hold'] }
                ],
            ...
            },
            {
                ...
                fields: [
                    ...
                    { id: '1772310760000-taskstatus', name: 'Status', type: 'option', optionValues: ['To Do', 'In Progress', 'In Review', 'Done'] },
                    { id: '1772310770000-storypoints', name: 'Story Points', type: 'number' }
                ],
        ...
        const records: EntityRecord[] = [
            ...
            // Projects
            { id: '1772310902001-project1', entityId: '1772310624109-pk7op268b', data: { '1772310628695-557i0oaa3': 'Website Redesign', '1772310676690-7nyjo5foq': 'Complete redesign and modernization', '1772310687667-3c24aocrb': '1772310900001-team1', '1772310706021-lhsg7gf8c': '20', '1772310750000-projectstatus': 'In Progress' } },
            { id: '1772310902002-project2', entityId: '1772310624109-pk7op268b', data: { '1772310628695-557i0oaa3': 'Mobile App Development', '1772310676690-7nyjo5foq': 'Create cross-platform mobile experience', '1772310687667-3c24aocrb': '1772310900001-team1', '1772310706021-lhsg7gf8c': '35', '1772310750000-projectstatus': 'Not Started' } },
            { id: '1772310902003-project3', entityId: '1772310624109-pk7op268b', data: { '1772310628695-557i0oaa3': 'Database Optimization', '1772310676690-7nyjo5foq': 'Optimize database for scale', '1772310687667-3c24aocrb': '1772310900001-team1', '1772310706021-lhsg7gf8c': '8', '1772310750000-projectstatus': 'Completed' } },
            { id: '1772310902004-project4', entityId: '1772310624109-pk7op268b', data: { '1772310628695-557i0oaa3': 'API Documentation', '1772310676690-7nyjo5foq': 'Create comprehensive API documentation', '1772310687667-3c24aocrb': '1772310900001-team1', '1772310706021-lhsg7gf8c': '5', '1772310750000-projectstatus': 'On Hold' } },
            // Tasks
            { id: '1772310903001-task1', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Design mockups', '1772310793220-tx3usihxv': '1772310901001-member1', '1772310812805-wbhza1et1': 'Create wireframes and high-fidelity mockups', '1772310819672-at1za4rik': 'Use Figma for design', '1772310760000-taskstatus': 'Done', '1772310770000-storypoints': '5' } },
            { id: '1772310903002-task2', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Implement frontend components', '1772310793220-tx3usihxv': '1772310901002-member2', '1772310812805-wbhza1et1': 'Build React components from mockups', '1772310819672-at1za4rik': 'Follow the design system', '1772310760000-taskstatus': 'In Progress', '1772310770000-storypoints': '8' } },
            { id: '1772310903003-task3', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Setup development environment', '1772310793220-tx3usihxv': '1772310901002-member2', '1772310812805-wbhza1et1': 'Configure local dev environment and deployment', '1772310819672-at1za4rik': 'Document setup process', '1772310760000-taskstatus': 'To Do', '1772310770000-storypoints': '3' } },
            { id: '1772310903004-task4', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Create database schema', '1772310793220-tx3usihxv': '1772310901001-member1', '1772310812805-wbhza1et1': 'Design and implement database tables', '1772310819672-at1za4rik': 'Use PostgreSQL', '1772310760000-taskstatus': 'In Review', '1772310770000-storypoints': '5' } },
            { id: '1772310903005-task5', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'API endpoint development', '1772310793220-tx3usihxv': '1772310901002-member2', '1772310812805-wbhza1et1': 'Build REST API endpoints for core features', '1772310819672-at1za4rik': 'Follow API design guidelines', '1772310760000-taskstatus': 'In Progress', '1772310770000-storypoints': '8' } },
            { id: '1772310903006-task6', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Write unit tests', '1772310793220-tx3usihxv': '1772310901001-member1', '1772310812805-wbhza1et1': 'Achieve 80%+ code coverage', '1772310819672-at1za4rik': 'Use Jest for testing', '1772310760000-taskstatus': 'To Do', '1772310770000-storypoints': '5' } },
            { id: '1772310903007-task7', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Performance optimization', '1772310793220-tx3usihxv': '1772310901002-member2', '1772310812805-wbhza1et1': 'Optimize images, bundle size, and API responses', '1772310819672-at1za4rik': 'Target < 3s initial load', '1772310760000-taskstatus': 'To Do', '1772310770000-storypoints': '8' } },
            { id: '1772310903008-task8', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Security audit', '1772310793220-tx3usihxv': '1772310901001-member1', '1772310812805-wbhza1et1': 'Review and fix security vulnerabilities', '1772310819672-at1za4rik': 'Check OWASP top 10', '1772310760000-taskstatus': 'In Review', '1772310770000-storypoints': '5' } },
            { id: '1772310903009-task9', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'User acceptance testing', '1772310793220-tx3usihxv': '1772310901002-member2', '1772310812805-wbhza1et1': 'Conduct UAT with stakeholders', '1772310819672-at1za4rik': 'Document feedback and iterations', '1772310760000-taskstatus': 'To Do', '1772310770000-storypoints': '3' } },
            { id: '1772310903010-task10', entityId: '1772310728856-iqg7d9an4', data: { '1772310793220-asdfaisda':'1772310902001-project1', '1772310736904-87mgwxh0e': 'Deployment and launch', '1772310793220-tx3usihxv': '1772310901001-member1', '1772310812805-wbhza1et1': 'Deploy to production and monitor', '1772310819672-at1za4rik': 'Have rollback plan ready', '1772310760000-taskstatus': 'To Do', '1772310770000-storypoints': '5' } }
        ];
        const lists: List[] = [
